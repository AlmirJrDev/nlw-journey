...
interface DestinatioAndDateStepProps {
  isGuestsInputOpen: boolean;
  closeGuestsInput: () => void;
  openGuestsInput : () => void;
}
export function DestinatioAndDateStep({isGuestsInputOpen, closeGuestsInput, openGuestsInput}: DestinatioAndDateStepProps) {
  return(
